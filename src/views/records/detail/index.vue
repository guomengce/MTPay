...
const route=useRoute();const router=useRouter();const loading=ref(false);usePageLoading(loading);const invalid=ref(false);const info=ref<TransactionInfoResult|null>(null);const{loading:fileLoading,openPreview,triggerDownload}=useWithdrawalFiles();
