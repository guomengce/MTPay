...
function partyLabel(name?:string|null,typeName?:string|null,type?:1|2|null){const entity=typeName||(type===1?'公司':type===2?'个人':'');return[name,entity].filter(Boolean).join(' · ')}
